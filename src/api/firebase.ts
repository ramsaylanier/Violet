...
export async function setupFirebaseStorage(data: { projectId: string }): Promise<any> {
  return apiPost<any>('/firebase/setup-storage', data);
}

export async function setupFirebaseHosting(data: { projectId: string }): Promise<any> {
