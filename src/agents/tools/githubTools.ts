...
export const githubTools = [
  {
    ...
    description: 'Create a new GitHub repository. Use this when the user wants to create a new repository.',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: 'Create a new GitHub issue in a repository. Use this when the user wants to create an issue.',
    inputSchema: {
      type: 'object',
      properties: {
        owner: { type: 'string', description: 'The owner of the repository (username or org)' },
  ...
  },
  {
    ...
    description: 'List all GitHub repositories for the authenticated user. Use this to see what repositories exist.',
    inputSchema: {
      type: 'object',
      properties: {},
    },
