...
import type { Project, CloudflareDNSRecord } from "@/types";
...
import { deleteCloudflareDNSRecord } from "@/api/cloudflare";
import { listFirebaseHostingSites, addFirebaseDomain } from "@/api/firebase";
